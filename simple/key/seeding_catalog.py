...
EMPLOYEE_SPECS = [
    ...
    ('manager', 'Ксения', 'Лебедева', 'Менеджер клиентского сервиса'),
    ('manager', 'Артём', 'Грачёв', 'Менеджер по сопровождению сделок'),
    ('manager', 'Екатерина', 'Титова', 'Менеджер контроля качества'),
...
PROPERTY_BLUEPRINTS = [
    ...
    ('chita', 'commercial', 'warehouse', None, '420.0', 1, 2, None, 'warehouse', 'sale', 'active'),
